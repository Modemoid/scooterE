...
_0x0:
	...
	.DB  0x20,0x25,0x75,0x0,0x50,0x75,0x6C,0x73
...
; 0000 0237         }
; 0000 0238     }
; 0000 0239             Vol_int=encoder_int(Vol_int,10);
_0x77:
	RCALL SUBOPT_0x25
	RCALL SUBOPT_0x10
	LDI  R26,LOW(10)
...
; 0000 023B         OCR1A=Vol_int*2;
	...
	OUT  0x2A+1,R31
	OUT  0x2A,R30
; 0000 023C         if (m4)    sprintf(buf,"PulseGen        ON %u",Vol_int);
	CPI  R21,0
	BREQ _0x7C
	RCALL SUBOPT_0xF
